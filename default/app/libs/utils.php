...
elseif (in_array($tag, $single_tags)) {
     ...
     */
    public static function truncateWord ($text, $limit, $end)
    {
		...
		//TOTE traduccion completa de entidades...
	...
	public static function truncateDate($date, $format) {
	...
	//Tote
	//1-2-2012
	//Funcion para obtener IP del navegante
