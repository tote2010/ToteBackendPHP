...
class View extends KumbiaView {
    ...
    /**
     * Renderiza un sidebar para el usuario conectado y para el entorno especificado.
     * @param  int $entorno 
     */
    public static function renderSidebar($entorno) {
        if (MyAuth::es_valido()) {
            echo Sidebar::render(Auth::get('id'), $entorno);
        }
    }
