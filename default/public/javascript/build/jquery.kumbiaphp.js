	...
	$.KumbiaPHP = {
		...
		cConfirm: function(event) {
                    ...
                    if ($("#modal_confirmar").size() == 0) {
                        ...
                        var close = $('<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title">Confirmar !</h4>');
                        var body = $('<div><p></p></div>').addClass('modal-body');
                        ...
                        dialogo.append(dialog);
                        footer.append('<a class="btn btn-default" href="#modal_confirmar" data-toggle="modal">No</a>');
